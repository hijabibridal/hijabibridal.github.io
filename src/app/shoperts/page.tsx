          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory scroll-smooth gap-8 pb-4 xl:overflow-hidden select-none">
            ...
            <div id="step-9" className="w-full flex-shrink-0 snap-start grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed mb-6">
                  While online standards fluctuate, our system operates at a highly focused <strong>5.21% purchase rate</strong> on Amazon. Based on our 307 clicks that went to Amazon during the last 28 days out of 1425 overall, our estimated CTR for Amazon is over 20%. 4% conversion on 307 clicks is an expected 12 buys, but we achieved 16. More than half of these purchases, however, are outside you industry, in the nails category. But because, as you stated, the bridal market is heavily into customization, not readymade, we estimate your CTR from our site to be at least 10% - 5 serious buyers per month. That's a very conservative estimate, as our traffic is growing each month. We just got our first 100 clicks/month in April and in July we're at 800. We're happy to follow the numbers and make any adjustments to this plan towards our joint success. We will use custom tag parameters to track clicks to your site, and we request a **10% commission on finalized orders**.
                </p>
                <div className="flex gap-3">
